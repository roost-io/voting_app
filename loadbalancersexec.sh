...
sed -i -e "s#REACT_APP_BALLOT_ENDPOINT_VALUE#${ballot_loadbalancer}#" -e "s#REACT_APP_EC_SERVER_ENDPOINT_VALUE#${ecserver_loadbalancer}#" voter/voter.yaml
...
sed -i -e "s#EC_SERVER_ENDPOINT_VALUE#${ecserver_loadbalancer}#" election-commission/ec.yaml
